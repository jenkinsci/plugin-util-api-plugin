...
image:https://github.com/jenkinsci/plugin-util-api-plugin/workflows/GitHub%20Actions/badge.svg[GitHub Actions, link={https://github.com/jenkinsci/plugin-util-api-plugin/actions}]
